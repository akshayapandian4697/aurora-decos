<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="AuroraDecos.Checkout" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="navPlaceHolder" runat="server">
    <div class="d-flex flex-column justify-content-evenly align-items-center">
        ...
        <h3>Optional Data:</h3>
            <table>
                <tr>
                    <td><h4>Please let us know if any delivery instructions:</h4></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="txtDelivery" runat="server" Width="500px" Height="100px"></asp:TextBox>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <asp:RadioButton ID="rbtnFacebook" runat="server" Text="Facebook" Font-Size="18px"/>&nbsp;&nbsp;
        ...
        <div>
            ...
            <asp:HyperLink ID="hlContinueShopping" runat="server" NavigateUrl="~/Indoor.aspx" Font-Size="18px">Continue Shopping</asp:HyperLink>
        </div><br />
    </div>
</asp:Content>
