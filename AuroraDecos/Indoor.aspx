<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Indoor.aspx.cs" Inherits="AuroraDecos.Indoor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="navPlaceHolder" runat="server">
    ...
    <h2 class="text-center subheadings">
        <asp:Label ID="Label10" runat="server" Text="Indoor Decos" CssClass="text-success"></asp:Label>
        
    </h2>

    <asp:Image ID="backImage" ImageAlign="Middle" CssClass="w-100 align-content-center" runat="server" ImageUrl="~/IMG/indoor3.jpg" Width="900px" />
        ...
        <div>
            <table id="tblProductss">
                ...
                <tr>
                    <td>
                        <div>
                            <asp:DataList ID="DataList1" runat="server" DataSourceID="IndoorCategoryDataSource" HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" RepeatColumns="6" DataKeyField="Id">
                            ...
                            <asp:SqlDataSource ID="IndoorCategoryDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:AuroraConnectionString %>" SelectCommand="SELECT [Id], [Name], [ImagePath] FROM [tblItemsCatgory] WHERE ([CategoryId] = @CategoryId)">
                                <SelectParameters>
            ...
            <div id="divDecoProductDetail">
                <asp:Table ID="tblProductDetail" runat="server" Visible="false">
                    ...
                    <asp:TableRow>
                            ...
                            <table id="tblProductItemDetail">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <asp:Label ID="lblProdName" runat="server" Text="Wood candle" Font-Bold="True" ForeColor="Maroon" Font-Size="X-Large"></asp:Label>
                                ...
                                <tr>
                                    <td aria-multiline="True" class="auto-style1" colspan="2">
                                        <asp:Label ID="lblDescription1" runat="server" Text="Wood candle description" Width="500px"></asp:Label>
                                    </td>
                                </tr>
                        ...
                        <asp:TableCell class="auto-style2" HorizontalAlign="Center" VerticalAlign="Middle">
                            <asp:Image ID="prodImg" runat="server" ImageUrl="~/IMG/pots.jpg" Width="60%" />
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
